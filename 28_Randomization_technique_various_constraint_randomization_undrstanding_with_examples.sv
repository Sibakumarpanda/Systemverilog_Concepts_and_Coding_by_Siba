...
//////////////////////////////////////////////////////////////////
-Randomization is a process/technique of producing random values of the mentioned data type.
-As SystemVerilog deals with objects, the $random method from Verilog is not sufficient for randomizing an object.
 ...
 -There can be multiple cross combination of variables in a real system. 
 -So, it is not possible practically to write directed cases to verify every possible combination. 
 -Hence,it is very much required to have randomization in the verification testbench.
...
///////////////////////////////////      
 ...
 -SystemVerilog randomization provides flexibility to disable randomization for a particular variable in a class 
  and also to disable particular constraints based on the requirement.
...
- syntax: rand bit [4:0] value; // 5bit (32 combinations) values are between 0 to 31 
...
class derived_class_item extends base_class_item;
  function void pre_randomize();
    $display("FROM_DERIVED_CLASS : Inside pre_randomize of derived_item class");
  endfunction
  
  function void post_randomize();
    $display("FROM_DERIVED_CLASS : Inside post_randomize of derived_item class");
    $display("FROM_DERIVED_CLASS_POST_RAND_VALS : val1 = %0d, val2 = %0d", this.val1, this.val2);
  endfunction
  
endclass : derived_class_item

module constraint_example28;
...
endmodule :constraint_example28

//Logfile Output
FROM_BASE_CLASS: Inside pre_randomize
FROM_BASE_CLASS : Inside post_randomize
FROM_BASE_CLASS_POST_RAND_VALS: val1 = 121, val2 = 7
FROM_DERIVED_CLASS : Inside pre_randomize of derived_item class
FROM_DERIVED_CLASS : Inside post_randomize of derived_item class
FROM_DERIVED_CLASS_POST_RAND_VALS : val1 = 107, val2 = 7
           V C S   S i m u l a t i o n   R e p o r t      
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////
   Example30: Constraints Randomization 
/////////////////////////////////////////////////////////////////////////////////////////////////////////           
class base_class_item;
  rand bit [7:0] val1;
  rand bit [7:0] val2;
...
module constraint_example30;
  ...
  initial begin
    ...
    //b_item.randomize();
    b_item.randomize with {val1 inside {[150:180]};};
    //d_item.randomize();
    d_item.randomize with {val2 == 7;};
  end
endmodule :constraint_example30

//Logfile Output
FROM_BASE_CLASS: Inside pre_randomize
FROM_BASE_CLASS : Inside post_randomize
FROM_BASE_CLASS_POST_RAND_VALS: val1 = 171, val2 = 7
FROM_DERIVED_CLASS : Inside pre_randomize of derived_item class
FROM_DERIVED_CLASS : Inside post_randomize of derived_item class
FROM_DERIVED_CLASS_POST_RAND_VALS : val1 = 107, val2 = 7
           V C S   S i m u l a t i o n   R e p o r t          
