...
////////////////////////////////////////////////////////////////////////////////////////////////////////
//(c) Copyright Siba Kumar Panda, All rights reserved
// File    : 19_tb_clock_gen_with_dc.sv 
// Project : tb_clock_gen_with_various_duty_cycle.sv
// Purpose : Generate 1GHZ clock with 80% Duty Cycle using always block
// Author  : Siba Kumar Panda
////////////////////////////////////////////////////////////////////////////////////////////////////////
...
DUTY CYCLE = Thigh/ (Thigh+Tlow) = Thigh/ (Tperiod)
Given Frequency =1GHz , So Time Period = 1/Tperiod = 1/1GHz = 1ns
Hence from 1ns of total time period , 80% we have to take as Thigh and 20% as Tlow
80 % 1ns = 0.8ns =Thigh
20 % 1ns = 0.2ns =Tlow
*/

`timescale 1ns / 1ps   // unit = 1ns, precision = 1ps
module tb_clock_gen_with_dc_ex19;
  bit clk; 
  always begin      // clk frequency=1GHZ ,Time period =1ns , 0.8ns High and 0.2ns Low
    clk = 1'b1;
    #0.8;
    clk = 1'b0;
    #0.2;
...
endmodule: tb_clock_gen_with_dc_ex19

////////////////////////////////////////////////////////////////////////////////////////////////////////
//(c) Copyright Siba Kumar Panda, All rights reserved
// File    : 20_tb_clock_gen_with_dc.sv 
// Project : tb_clock_gen_with_various_duty_cycle.sv
// Purpose : Generate 2GHZ clock with 80% Duty Cycle using always block
// Author  : Siba Kumar Panda
////////////////////////////////////////////////////////////////////////////////////////////////////////
...
DUTY CYCLE = Thigh/ (Thigh+Tlow) = Thigh/ (Tperiod)
Given Frequency =2GHz , So Time Period = 1/Tperiod = 1/2GHz = 0.5ns
Hence from 0.5ns of total time period , 80% we have to take as Thigh and 20% as Tlow
80 % 0.5ns = 0.4ns =Thigh
20 % 0.5ns = 0.1ns =Tlow
*/
...
////////////////////////////////////////////////////////////////////////////////////////////////////////
//(c) Copyright Siba Kumar Panda, All rights reserved
// File    : 22_tb_clock_gen_with_dc.sv 
// Project : tb_clock_gen_with_various_duty_cycle.sv
// Purpose : Generate 200MHZ clock with 85% Duty Cycle using always block
// Author  : Siba Kumar Panda
////////////////////////////////////////////////////////////////////////////////////////////////////////
...
DUTY CYCLE = Thigh/ (Thigh+Tlow) = Thigh/ (Tperiod)
Given Frequency =200MHz , So Time Period = 1/Tperiod = 1/200MHz = 5ns
Hence from 5ns of total time period , 85% we have to take as Thigh and 15% as Tlow
85 % 5ns = 4.25ns =Thigh
15 % 5ns = 0.75ns =Tlow
*/
`timescale 1ns / 1ps   // unit = 1ns, precision = 1ps
module tb_clock_gen_with_dc_ex22;
  bit clk;  
  always begin      // clk frequency=200MHZ ,Time period =5ns , 4.25ns High and 0.75ns Low
    clk = 1'b1;
    #4.25;
    clk = 1'b0;
    #0.75;
...
endmodule: tb_clock_gen_with_dc_ex22

////////////////////////////////////////////////////////////////////////////////////////////////////////
//(c) Copyright Siba Kumar Panda, All rights reserved
// File    : 23_tb_clock_gen_with_dc.sv 
// Project : tb_clock_gen_with_various_duty_cycle.sv
// Purpose : Generate 50MHZ clock with 85% Duty Cycle using always block
// Author  : Siba Kumar Panda
////////////////////////////////////////////////////////////////////////////////////////////////////////
...
DUTY CYCLE = Thigh/ (Thigh+Tlow) = Thigh/ (Tperiod)
Given Frequency =50MHz , So Time Period = 1/Tperiod = 1/50MHz = 20ns
Hence from 20ns of total time period , 85% we have to take as Thigh and 15% as Tlow
85 % 20ns = 17ns =Thigh
15 % 20ns = 3ns =Tlow
*/
`timescale 1ns / 1ps    // unit = 1ns, precision = 1ps
module tb_clock_gen_with_dc_ex23;
  bit clk;
  always begin          // clk frequency=50MHZ ,Time period =20ns ,17ns High and 3ns Low
    clk = 1'b1;
    #17;
    clk = 1'b0;
    #3;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////
//(c) Copyright Siba Kumar Panda, All rights reserved
// File    : 25_tb_clock_gen_with_dc.sv 
// Project : tb_clock_gen_with_various_duty_cycle.sv
// Purpose : Generate 2GHZ clock with 85% Duty Cycle using always block
// Author  : Siba Kumar Panda
////////////////////////////////////////////////////////////////////////////////////////////////////////
...
DUTY CYCLE = Thigh/ (Thigh+Tlow) = Thigh/ (Tperiod)
Given Frequency =2GHz , So Time Period = 1/Tperiod = 1/2GHz = 0.5ns
Hence from 0.5ns of total time period , 85% we have to take as Thigh and 15% as Tlow
85 % 0.5ns =0.425ns =Thigh
15 % 0.5ns =0.075ns =Tlow
*/

`timescale 1ns / 1ps       // unit = 1ns, precision = 1ps
module tb_clock_gen_with_dc_ex25;
  bit clk;  
  always begin            // clk frequency=1GHZ ,Time period =0.5ns ,0.425ns High and 0.075ns Low
    clk = 1'b1;
    #0.425;
    clk = 1'b0;
    #0.075;
...
endmodule: tb_clock_gen_with_dc_ex25
